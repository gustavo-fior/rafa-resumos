...
export default function AboutPage() {
    return (<main className="mx-auto w-full max-w-4xl px-4 py-12 pt-6 md:px-0">
      <div className="mb-6 flex items-center justify-between gap-3">
        ...
        <Link href="https://www.linkedin.com/in/rafaela-castan-7a43ab2bb/" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="text-[#9b9a97] transition-colors hover:text-[#37352f]">
      ...
      <div className="space-y-5 text-[15px] leading-relaxed text-[#37352f]">
        ...
        <p>
          ...
          <Link href="mailto:rafacastan.resumos@gmail.com" className="underline decoration-[#9b9a97] underline-offset-[3px] transition-colors hover:decoration-[#37352f]">
            rafacastan.resumos@gmail.com
          </Link>
          ) ou pelo meu Instagram (
          <Link href="https://www.instagram.com/rafa_epc_" target="_blank" rel="noreferrer" className="underline decoration-[#9b9a97] underline-offset-[3px] transition-colors hover:decoration-[#37352f]">
            @rafa_epc_
          </Link>
