...
export default async function ReaderPage({
  ...
  if (!product.hasAccess) {
    return (
      <main className="mx-auto w-full max-w-4xl px-4 py-12 md:px-0">
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            <Link
              ...
              className="flex h-9 items-center justify-center rounded bg-[#37352f] px-4 text-sm font-medium text-white transition-colors hover:bg-[#2f2d29]"
            >
              Ver detalhes do resumo
            </Link>
            <Link
              href="/dashboard/library"
              className="flex h-9 items-center justify-center rounded border border-[#ededec] bg-white px-4 text-sm text-[#37352f] transition-colors hover:bg-[#fbfbfa]"
            >
